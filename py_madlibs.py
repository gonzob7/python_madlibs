...
#These lists serve a purpose for the random module. Whenever the user cant think of a word, they could just input "R" and the program
#will grab a random word from here and insert it into the madlib story.
